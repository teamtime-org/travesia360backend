...
public class UpdateTimeEntryCommandHandler : ICommandHandler<UpdateTimeEntryCommand, Result<TimeEntryDto>>
{
    ...
    public async Task<Result<TimeEntryDto>> HandleAsync(UpdateTimeEntryCommand command, CancellationToken cancellationToken = default)
    {
        // Validate command
        ...
        try
        {
            ...
            timeEntry.UpdateHours(command.Hours);
